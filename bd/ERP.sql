...
INSERT INTO ERP.ORDEMPRODUCAO_MATERIAPRIMA (ID_ORDEMPRODUCAO, ID_MATERIAPRIMA) VALUES (1 , 1);
...
SELECT OP.*, M.NOME, M.QUANTIDADE, M.FABRICANTE, M.SELECIONADO FROM ERP.ORDEMPRODUCAO OP 
